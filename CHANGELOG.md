...
* fix(deps): update dependency prettytable to v3.12.0 ([`d4d454a`](https://github.com/nwhobart/pvb/commit/d4d454a7560e42f658debd710acff99b05e2afcd))
...
* fix(deps): update dependency redis to v5.2.0 ([`5530f30`](https://github.com/nwhobart/pvb/commit/5530f30b404a50ba258a88d4cc6c710cd8f5c8d1))

### Chores

* chore(deps): update actions/checkout digest to 11bd719 ([`cd87e54`](https://github.com/nwhobart/pvb/commit/cd87e546d496a9b885ddc2a07ed27b0c1c2e2092))
...
* fix(deps): update dependency redis to v5.0.7 ([`1c10f6d`](https://github.com/nwhobart/pvb/commit/1c10f6d9ee46a649da290287f75f8eba35fe4818))
...
* chore(deps): update actions/cache action to v4 ([`17dcf8e`](https://github.com/nwhobart/pvb/commit/17dcf8ef57d392bded9603501781692c33a94c25))

* chore(deps): update actions/setup-python action to v5 ([`b271d43`](https://github.com/nwhobart/pvb/commit/b271d4379f286201ecc25b4abae29176e110d58f))

* chore(deps): update actions/checkout digest to 692973e ([`6627fc6`](https://github.com/nwhobart/pvb/commit/6627fc6220ad2073c3f6c9b88fa4641f5e044fa3))
...
* fix: renaming file ([`1f6af7f`](https://github.com/nwhobart/pvb/commit/1f6af7f8b0d96c8c791fd5fe69ab3aad3c4f8e3d))
...
* chore: some fixes ([`34e6a6d`](https://github.com/nwhobart/pvb/commit/34e6a6d7b96b22c9b7d2eaaab37878269f662057))

* chore: trying multi arch build ([`896f652`](https://github.com/nwhobart/pvb/commit/896f6524bd9773835de70e4cc72f3bd102049563))
...
* fix: wrong image ([`eefb68b`](https://github.com/nwhobart/pvb/commit/eefb68b9ed2f68152e7325ceba69f56ce21b899a))
...
* fix: semantic release badge fix ([`d48702b`](https://github.com/nwhobart/pvb/commit/d48702b6c96cc42018bd896370361e7c106c9289))

* Feat/adding dockerfile (#4)

* feat: adding dockerfile

* feat: bookmark

* feat: moving some things around

* feat: black formatted

* feat: adding black linter

* feat: fixing thing black caught
...
* Initial commit ([`59538ac`](https://github.com/nwhobart/pvb/commit/59538ac852779c69ed020b2c824b4db592df8131))
